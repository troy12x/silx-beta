/**
 * v0 by Vercel.
 * @see https://v0.dev/t/BMxY03HsHDP
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      <Card className="h-[390px]">
        <CardHeader>
          <CardTitle>Working with team skill</CardTitle>
      ...
      <Card className="h-[390px]">
        <CardHeader>
          <CardTitle>Company Grow</CardTitle>
      ...
      <Card className="h-[390px]">
        <CardHeader>
        <CardTitle>Coding Quilty</CardTitle>
          <CardDescription>In 2023</CardDescription>
        </CardHeader>
        <CardContent>
